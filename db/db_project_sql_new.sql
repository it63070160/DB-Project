...
INSERT INTO `credit_account` VALUES ('0000000001'),('0000000002'),('0000000004'),('0000000007'),('0000000010'),('0000000012'),('0000000013'),('0000000014'),('0000000016'),('0000000017'),('0000000018'),('0000000021');
...
CREATE TABLE `credit_card` (
  ...
  CONSTRAINT `credit_card_account_number_fk` FOREIGN KEY (`account_number`) REFERENCES `credit_account` (`account_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('2','pawi','prem','555555','customer'),('3','peera','don','111111','customer'),('4','ram','makon','654321','customer'),('5','pasu','tachan','789456','customer'),('6','sarun','ched','852741','customer'),('7','chana','yut','951489','customer'),('8','alex','chano','548962','customer'),('9','john','olala','324561','customer'),('Jwick111','jame','wick','614587','customer'),('VeerawatK','Veera','Kamol','$2b$05$sYMPET8LF4cHkbOj15FW6O.YoBqUukunp2EZ5Q5ONi.6kDbSxVQi.','employee');
...
-- Dump completed on 2022-04-30 15:03:49
